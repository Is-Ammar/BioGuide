...
const Landing = () => {
  return (
    <div className="min-h-screen nebula-bg overflow-hidden">
      <Navigation />
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4">
        ...
        <div className="text-center z-10 max-w-4xl mx-auto">
          <motion.h1
            className="text-6xl md:text-8xl font-black mb-8 bg-gradient-to-r from-white via-cosmic-300 to-neon-cyan bg-clip-text text-transparent"
          ...
          >
            ...
            <p className="text-3xl md:text-4xl font-medium bg-gradient-to-r from-bio-400 to-cosmic-400 bg-clip-text text-transparent">
          ...
          >
            <motion.div
              className="absolute inset-0 rounded-full border-2 border-cosmic-400/30"
              animate={{ rotate: 360 }}
            ...
            >
              <Link
                to="/dashboard"
                className="block glass px-8 py-4 rounded-full neon-glow hover:scale-110 transition-all duration-300 group"
              >
                <div className="flex items-center gap-3">
                  <Search className="w-5 h-5 text-neon-cyan" />
                  <span className="text-white font-medium">Explore Dashboard</span>
                  <motion.div
          ...
          >
            {[
              ...
              <motion.div
                key={index}
                className="glass-dark p-6 rounded-xl text-center hover:scale-105 transition-all duration-300"
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
